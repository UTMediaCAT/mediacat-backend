...
''' This script takes a list of months as input within its main() method on line 103,
	...
	This script is provided as a way to validate article count from NYT on the MediaCAT project, 
	as output can be filtered by 'subsection' to obtain the counts for articles on a specific topic.
...
def get_data(dates):
    '''Sends and parses request/response to/from NYT Archive API for provided months'''
    total = 0
